...
<div class="bg-white shadow-md rounded-lg p-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex space-x-2">
            <a href="{{ route('admin.events.edit', $event->id) }}" class="bg-yellow-500 hover:bg-yellow-600 text-white font-medium py-2 px-4 rounded-md flex items-center">
                ...
                <div class="flex flex-wrap gap-2 mb-4">
                    ...
                    @elseif($event->audience == 'admin')
                        <span class="inline-flex items-center px-3 py-1 bg-purple-100 text-purple-800 text-sm font-medium rounded-full">
                            <i class="fas fa-user-shield mr-1"></i> Untuk Admin
                        </span>
                    @endif
                ...
                <table class="w-full">
                    <tbody>
                        <tr>
                            ...
                            <td>{{ $event->creator ? $event->creator->name : 'Unknown' }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="py-2 text-gray-600">Terakhir diubah</td>
