    ...
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md">
        <form action="{{ route('guru.exams.store') }}" method="POST">
            ...
            <div class="grid gap-6 mb-4 md:grid-cols-2">
                ...
                <div class="col-span-2">
                    <label class="block text-sm">
                        ...
                        <textarea name="description" rows="3"
                            ...
                            placeholder="Masukkan deskripsi atau petunjuk ujian">{{ old('description') }}</textarea>
                    </label>
                </div>
                ...
                <div>
                    <label class="block text-sm">
                        ...
                        <input type="number" name="passing_score" value="{{ old('passing_score', 75) }}" min="0" max="100"
                            class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-blue-400 focus:outline-none focus:shadow-outline-blue dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                        ...
                        @foreach ($classrooms as $classroom)
                            <label class="inline-flex items-center text-sm">
                                <input type="checkbox" name="classrooms[]" value="{{ $classroom->id }}"
                                    {{ (is_array(old('classrooms')) && in_array($classroom->id, old('classrooms'))) ? 'checked' : '' }}
            ...
            <div class="block text-sm mb-4">
                ...
                <div class="mt-2">
                    <label class="inline-flex items-center text-sm">
                        <input type="checkbox" name="show_result" {{ old('show_result', true) ? 'checked' : '' }}
                            class="text-blue-600 form-checkbox focus:border-blue-400 focus:outline-none focus:shadow-outline-blue dark:focus:shadow-outline-gray">
