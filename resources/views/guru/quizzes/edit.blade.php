...
@section('content')
    ...
    <div class="mb-6">
        <a href="{{ route('guru.quizzes.show', $quiz->id) }}" class="inline-flex items-center text-yellow-600 hover:text-yellow-800 transition-colors">
    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100/50 transform transition hover:shadow-md">
        <div class="p-6">
            <form action="{{ route('guru.quizzes.update', $quiz->id) }}" method="POST" class="animate-fade-in" id="quizForm">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="form-group mb-5 md:col-span-2">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            <textarea name="description" id="description" rows="3" 
                                class="w-full rounded-lg border-gray-300 focus:border-yellow-500 focus:ring focus:ring-yellow-200 focus:ring-opacity-50 transition-shadow duration-300">{{ old('description', $quiz->description) }}</textarea>
                        </div>
                                ...
                                @foreach($classrooms ?? [] as $classroom)
                                    <div class="flex items-center">
                                        <input type="checkbox" id="classroom_{{ $classroom->id }}" name="classroom_id[]" value="{{ $classroom->id }}"
                                            ...
                                            {{ in_array($classroom->id, old('classroom_id', $selectedClassrooms ?? [])) ? 'checked' : '' }}>
                    ...
                    <div class="form-group mb-5">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input type="number" name="duration" id="duration" value="{{ old('duration', $quiz->duration) }}" min="1" 
                                class="pl-10 w-full rounded-lg border-gray-300 focus:border-yellow-500 focus:ring focus:ring-yellow-200 focus:ring-opacity-50 transition-shadow duration-300" required>
                        </div>
                    ...
                    <div class="form-group mb-5">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input type="number" name="max_attempts" id="max_attempts" value="{{ old('max_attempts', $quiz->max_attempts) }}" min="1" 
                    ...
                    <div class="form-group mb-5">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input type="number" name="passing_grade" id="passing_grade" value="{{ old('passing_grade', $quiz->passing_grade) }}" min="0" max="100" 
                                class="pl-10 w-full rounded-lg border-gray-300 focus:border-yellow-500 focus:ring focus:ring-yellow-200 focus:ring-opacity-50 transition-shadow duration-300">
                        </div>
                        ...
                        <div class="mt-1 bg-white rounded-lg border border-gray-300 px-4 py-3 space-y-3">
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input id="is_random" name="is_random" type="checkbox" value="1" {{ old('is_random', $quiz->is_random) ? 'checked' : '' }}
                            ...
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input id="show_answers" name="show_answers" type="checkbox" value="1" {{ old('show_answers', $quiz->show_answers) ? 'checked' : '' }}
                                        class="rounded border-gray-300 text-yellow-600 focus:ring-yellow-500">
                                </div>
                                <div class="ml-3">
                            ...
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input id="is_active" name="is_active" type="checkbox" value="1" {{ old('is_active', $quiz->is_active) ? 'checked' : '' }}
                                        class="rounded border-gray-300 text-yellow-600 focus:ring-yellow-500">
                                </div>
                                <div class="ml-3">
                ...
                <div class="border-t border-gray-200 mt-8 pt-5">
                    <div class="flex justify-end">
                        <a href="{{ route('guru.quizzes.show', $quiz->id) }}" class="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-colors duration-300">
