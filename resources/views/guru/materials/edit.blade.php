...
@section('header', 'Edit Materi Pelajaran')
...
@section('content')
    ...
    <div class="bg-gradient-to-r from-indigo-500 to-indigo-600 rounded-xl shadow-lg p-6 mb-6 text-white relative overflow-hidden animate-fade-in">
        ...
        <div class="relative z-10 flex justify-between items-center">
            ...
            <div class="flex space-x-2">
                <a href="{{ route('guru.materials.show', $material) }}" class="inline-flex items-center px-4 py-2 bg-white text-indigo-600 rounded-lg font-medium shadow-sm hover:bg-indigo-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors duration-300">
                    <i class="fas fa-eye mr-2"></i> Lihat Detail
                </a>
                <a href="{{ route('guru.materials.index') }}" class="inline-flex items-center px-4 py-2 bg-white text-indigo-600 rounded-lg font-medium shadow-sm hover:bg-indigo-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors duration-300">
    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100/50 transform transition hover:shadow-md">
        <div class="p-6">
            <form action="{{ route('guru.materials.update', $material) }}" method="POST" enctype="multipart/form-data" class="animate-fade-in" id="materialForm">
                @csrf
                @method('PUT')
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="form-group mb-5 md:col-span-2">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title', $material->title) }}" 
                                class="pl-10 w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 transition-shadow duration-300 @error('title') border-red-300 focus:border-red-500 focus:ring-red-200 @enderror" required>
                        </div>
                        @error('title')
                    ...
                    <div class="form-group mb-5 md:col-span-2">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            <textarea name="description" id="description" rows="6" 
                                class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 transition-shadow duration-300 @error('description') border-red-300 focus:border-red-500 focus:ring-red-200 @enderror" required>{{ old('description', $material->description) }}</textarea>
                        </div>
                        @error('description')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="form-group mb-5">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <select name="subject_id" id="subject_id" 
                                class="pl-10 w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 transition-shadow duration-300 @error('subject_id') border-red-300 focus:border-red-500 focus:ring-red-200 @enderror" required>
                    ...
                    <div class="form-group mb-5">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <select name="classroom_id[]" id="classroom_id" multiple 
                                class="pl-10 w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 transition-shadow duration-300 @error('classroom_id') border-red-300 focus:border-red-500 focus:ring-red-200 @enderror" required>
                                @foreach($classrooms as $classroom)
                                    <option value="{{ $classroom->id }}" {{ (in_array($classroom->id, old('classroom_id', $selectedClassrooms))) ? 'selected' : '' }}>
                    ...
                    <div class="form-group mb-5 md:col-span-2">
                        ...
                        <div class="flex items-center p-4 bg-gray-50 rounded-lg border border-gray-200">
                            <div class="{{ $material->getFileColorAttribute() }} bg-opacity-20 p-3 rounded-full mr-3">
                                <i class="fas {{ $material->getFileIconAttribute() }} {{ $material->getFileColorAttribute() }}"></i>
                            </div>
                            <div>
                                <p class="font-medium">{{ basename($material->file_path) }}</p>
                                <p class="text-xs text-gray-500">{{ $material->getFileType() }}</p>
                            </div>
                            <a href="{{ route('guru.materials.download', $material) }}" class="ml-auto inline-flex items-center text-sm text-blue-600 hover:text-blue-800">
                    ...
                    <div class="form-group mb-5 md:col-span-2">
                        ...
                        <div class="mt-1">
                            <div class="flex justify-center px-6 pt-5 pb-6 border-2 border-dashed rounded-lg {{ $errors->has('material_file') ? 'border-red-500' : 'border-gray-300' }}">
                ...
                <div class="mt-8 flex justify-end space-x-3">
                    <a href="{{ route('guru.materials.show', $material) }}" class="inline-flex justify-center py-2 px-4 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                        Batal
                    </a>
