...
@section('content')
    ...
    <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl shadow-lg p-6 mb-6 text-white relative overflow-hidden animate-fade-in">
        ...
        <div class="relative z-10 flex justify-between items-center">
            ...
            <a href="{{ route('guru.materials.index') }}" class="inline-flex items-center px-4 py-2 bg-white text-blue-600 rounded-lg font-medium shadow-sm hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-300">
            ...
            <form action="{{ route('guru.materials.store') }}" method="POST" enctype="multipart/form-data" class="animate-fade-in" id="materialForm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="form-group mb-5 md:col-span-2">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title') }}" 
                                class="pl-10 w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 transition-shadow duration-300 @error('title') border-red-300 focus:border-red-500 focus:ring-red-200 @enderror" required>
                        </div>
                        @error('title')
                    ...
                    <div class="form-group mb-5 md:col-span-2">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            <textarea name="description" id="description" rows="6" 
                                class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 transition-shadow duration-300 @error('description') border-red-300 focus:border-red-500 focus:ring-red-200 @enderror" required>{{ old('description') }}</textarea>
                        </div>
                        @error('description')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="form-group mb-5">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <select name="subject_id" id="subject_id" 
                                class="pl-10 w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 transition-shadow duration-300 @error('subject_id') border-red-300 focus:border-red-500 focus:ring-red-200 @enderror" required>
                    ...
                    <div class="form-group mb-5">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <select name="classroom_id[]" id="classroom_id" multiple 
                                class="pl-10 w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 transition-shadow duration-300 @error('classroom_id') border-red-300 focus:border-red-500 focus:ring-red-200 @enderror" required>
                                @foreach($classrooms as $classroom)
                                    <option value="{{ $classroom->id }}" {{ (old('classroom_id') && in_array($classroom->id, old('classroom_id'))) ? 'selected' : '' }}>
                    ...
                    <div class="form-group mb-5 md:col-span-2">
                        ...
                        <div class="mt-1">                            <div class="flex justify-center px-6 pt-5 pb-6 border-2 border-dashed rounded-lg {{ $errors->has('material_file') ? 'border-red-500' : 'border-gray-300' }}">
                ...
                <div class="mt-8 flex justify-end space-x-3">
                    <a href="{{ route('guru.materials.index') }}" class="inline-flex justify-center py-2 px-4 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                        Batal
                    </a>
