                ...
                <div class="card-body p-0">
                    <div class="bg-primary p-4 text-center">
                        <div class="avatar-wrapper mb-3">
                            @if($user->avatar)
                                <img src="{{ asset('storage/' . $user->avatar) }}" alt="{{ $user->name }}" class="rounded-circle img-thumbnail border-white shadow" style="width: 100px; height: 100px; object-fit: cover;">
                            @else
                        ...
                        <p class="text-white-50 small mb-2">{{ $user->email }}</p>
                                ...
                                <div class="row mb-4">
                                        ...
                                        <div class="text-center">
                                            <div class="mb-3 position-relative d-inline-block">
                                                <div class="avatar-preview rounded-circle overflow-hidden mb-3 mx-auto border shadow" style="width: 150px; height: 150px;">
                                                    @if($user->avatar)
                                                        <img id="avatar-preview-img" src="{{ asset('storage/' . $user->avatar) }}" alt="{{ $user->name }}" class="img-fluid w-100 h-100 object-fit-cover">
                                                    @else
                                    ...
                                    <div class="col-lg-8">                                        <div class="mb-4">
                                            ...
                                            <div class="input-group input-group-seamless">
                                                ...
                                                <input type="text" class="form-control shadow-sm border-0" id="name" name="name" value="{{ old('name', $user->name) }}" required placeholder="Masukkan nama lengkap">
                                            </div>
                                            @error('name')
                                          ...
                                          <div class="mb-4">
                                            ...
                                            <div class="input-group input-group-seamless">
                                                ...
                                                <input type="email" class="form-control shadow-sm border-0" id="email" name="email" value="{{ old('email', $user->email) }}" required placeholder="email@example.com">
                                            </div>
                                            @error('email')
                                                <div class="text-danger small mt-1">
                                                    <i class="fas fa-exclamation-circle me-1"></i>
                                          ...
                                          <div class="mb-4">
                                            ...
                                            <div class="input-group input-group-seamless">
                                                ...
                                                <input type="text" class="form-control shadow-sm border-0" id="username" name="username" value="{{ old('username', $user->username) }}" required placeholder="Masukkan username">
                                            </div>
                                            @error('username')
                                                <div class="text-danger small mt-1">
                                                    <i class="fas fa-exclamation-circle me-1"></i>
