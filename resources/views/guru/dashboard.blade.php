...
@section('content')    <!-- Welcome Banner with enhanced gradient and floating shapes -->
    <div class="relative p-6 mb-6 overflow-hidden text-white shadow-xl bg-gradient-to-r from-green-500 via-teal-500 to-emerald-500 animate-gradient-x rounded-xl">
        ...
        <div class="relative z-10 animate-fade-in">
            ...
            <div class="flex flex-wrap gap-3 mt-4">
                ...
                <a href="{{ route('guru.assignments.index') }}" class="inline-flex items-center px-4 py-2 text-sm font-medium text-white transition-all duration-300 rounded-lg shadow-md bg-green-700/80 hover:bg-green-800 shadow-green-900/30 backdrop-blur-sm hover:shadow-xl hover:-translate-y-1">
        ...
        <div class="flex items-start space-x-4">
            ...
            <div class="flex-1">
                ...
                <p class="mt-1 text-sm text-amber-700">
                    ...
                    <a href="{{ route('guru.grades.index') }}" class="font-medium underline transition-colors hover:text-amber-800">Nilai sekarang</a>
                </p>
            </div>
        </div>
        ...
        <div class="relative p-6 overflow-hidden transition-all transform bg-white shadow-sm dashboard-card rounded-xl hover:scale-105">
            ...
            <div class="relative flex items-start">
                ...
                <div class="flex-1 ml-4">
                    ...
                    <div class="mt-2">
                        <a href="{{ route('guru.materials.index') }}" class="inline-flex items-center text-sm text-green-600 hover:text-green-800 group">
        ...
        <div class="relative p-6 overflow-hidden transition-all transform bg-white shadow-sm dashboard-card rounded-xl hover:scale-105">
            ...
            <div class="relative flex items-start">
                <div class="p-3 text-blue-600 bg-blue-100 rounded-lg shadow-inner">
                    ...
                    <div class="mt-2">
                        <a href="{{ route('guru.attendance.index') }}" class="inline-flex items-center text-sm text-blue-600 hover:text-blue-800 group">
        ...
        <div class="relative p-6 overflow-hidden transition-all transform bg-white shadow-sm dashboard-card rounded-xl hover:scale-105">
            ...
            <div class="relative flex items-start">
                ...
                <div class="flex-1 ml-4">
                    ...
                    <div class="mt-2">
                        <a href="{{ route('guru.assignments.index') }}" class="inline-flex items-center text-sm text-purple-600 hover:text-purple-800 group">
        ...
        <div class="relative p-6 overflow-hidden transition-all transform bg-white shadow-sm dashboard-card rounded-xl hover:scale-105">
            ...
            <div class="relative flex items-start">
                ...
                <div class="flex-1 ml-4">
                    ...
                    <div class="mt-2">
                        <a href="{{ route('guru.schedule.index') }}" class="inline-flex items-center text-sm text-amber-600 hover:text-amber-800 group">
        ...
        <div class="relative p-6 overflow-hidden transition-all transform bg-white shadow-sm dashboard-card rounded-xl hover:scale-105">
            ...
            <div class="relative flex items-start">
                ...
                <div class="flex-1 ml-4">
                    ...
                    <div class="mt-2">
                        <a href="{{ route('guru.grades.index') }}" class="inline-flex items-center text-sm text-red-600 hover:text-red-800 group">
    ...
    <div class="grid grid-cols-1 gap-6 mb-8 lg:grid-cols-3">        <!-- Recent Submissions (Left Column) -->
        <div class="overflow-hidden transition transform bg-white border shadow-sm lg:col-span-2 rounded-xl hover:shadow-lg border-gray-100/60">
            <div class="flex items-center justify-between p-6 border-b border-gray-100 card-header">
                ...
                <a href="{{ route('guru.assignments.index') }}" class="flex items-center text-sm font-medium text-green-600 hover:text-green-800 hover:underline group">
                            ...
                            <div class="flex items-center p-4 border border-gray-100 rounded-lg hover:bg-gray-50 transition-colors duration-300 
                                ...
                                <div class="flex items-center justify-center w-12 h-12 mr-4 overflow-hidden text-blue-600 bg-blue-100 border-2 border-blue-200 rounded-full">
                                    @if(isset($submission->student->profile_photo))
                                        <img src="{{ $submission->student->profile_photo }}" alt="{{ $submission->student->name }}" class="object-cover w-full h-full">
                                    @else
                                        <i class="text-xl fas fa-user-graduate"></i>
                                    @endif
                                </div>
                                <div class="flex-1">
                                    <div class="flex flex-col sm:flex-row sm:justify-between">
                                        ...
                                        <span class="mt-1 text-xs text-gray-500 sm:mt-0">{{ $submission->submitted_at ? $submission->submitted_at->diffForHumans() : 'Belum dikumpulkan' }}</span>
                                    </div>
                                    ...
                                    <div class="flex items-center justify-between mt-2">
                                        <span class="text-xs py-1 px-2 rounded-full {{ $submission->score ? 'bg-green-100 text-green-700' : ($submission->submitted_at ? 'bg-amber-100 text-amber-700' : 'bg-gray-100 text-gray-700') }}">
                                            @if($submission->score)
                                                <i class="mr-1 fas fa-check-circle"></i> Dinilai: {{ $submission->score }}/100
                                            ...
                                            <a href="{{ route('guru.assignments.submissions.show', [$submission->assignment_id, $submission->id]) }}" 
        ...
        <div>
            ...
            <div class="grid grid-cols-1 gap-4">
                <!-- Create Assignment -->
                <a href="{{ route('guru.assignments.create') }}" class="block p-4 transition-all duration-300 border border-gray-200 quick-action bg-gradient-to-r from-gray-50 to-gray-100 hover:from-green-50 hover:to-green-50 rounded-xl hover:-translate-y-2 hover:shadow-md group">
                    <div class="flex items-center">
                ...
                <!-- Upload Materials -->
                <a href="{{ route('guru.materials.create') }}" class="block p-4 transition-all duration-300 border border-gray-200 quick-action bg-gradient-to-r from-gray-50 to-gray-100 hover:from-blue-50 hover:to-blue-50 rounded-xl hover:-translate-y-2 hover:shadow-md group">
                    <div class="flex items-center">
                ...
                <!-- Record Attendance -->
                <a href="{{ route('guru.attendance.create') }}" class="block p-4 transition-all duration-300 border border-gray-200 quick-action bg-gradient-to-r from-gray-50 to-gray-100 hover:from-purple-50 hover:to-purple-50 rounded-xl hover:-translate-y-2 hover:shadow-md group">
                    <div class="flex items-center">
                ...
                <!-- Grade Assignments -->
                <a href="{{ route('guru.grades.index') }}" class="block p-4 transition-all duration-300 border border-gray-200 quick-action bg-gradient-to-r from-gray-50 to-gray-100 hover:from-orange-50 hover:to-orange-50 rounded-xl hover:-translate-y-2 hover:shadow-md group">
                    <div class="flex items-center">
    ...
    <div class="mb-10">
        <div class="flex items-center justify-between mb-4">
            ...
            <a href="{{ route('guru.schedule.index') }}" class="flex items-center text-sm font-medium text-blue-600 hover:text-blue-800 hover:underline group">
