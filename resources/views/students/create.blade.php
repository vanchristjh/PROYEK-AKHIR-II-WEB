        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">Formulir penambahan data siswa baru</p>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('students.store') }}" method="POST" class="form">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('nis') is-invalid @enderror" id="nis" name="nis" value="{{ old('nis') }}" required placeholder="Masukkan NIS">
                                    @error('nis')
                        ...
                        <div class="col-12 d-flex justify-content-end mt-3">
                            <a href="{{ route('students.index') }}" class="btn btn-light-secondary me-3 mb-1">Batal</a>
