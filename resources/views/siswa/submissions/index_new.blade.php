...
<div class="container-fluid">
    <!-- Page Header -->
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800 mb-1">Pengumpulan Tugas</h1>
        <nav class="flex" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-2">
                <li class="inline-flex items-center">
                    <a href="{{ route('siswa.dashboard') }}" class="text-sm text-blue-600 hover:text-blue-800">Dashboard</a>
                </li>
                <li class="inline-flex items-center">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Handle modal data passing for "Kumpulkan" buttons if Bootstrap JS is available
        if (typeof bootstrap !== 'undefined') {
