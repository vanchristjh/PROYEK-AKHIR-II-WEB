...
<div class="bg-white shadow-md rounded-lg p-6">
    <div class="flex items-center mb-6">
        <a href="{{ route('siswa.events.index') }}" class="flex items-center text-blue-500 hover:text-blue-700 mr-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="flex flex-wrap gap-2 mb-4">
                    ...
                    @elseif($event->audience == 'students')
                        <span class="inline-flex items-center px-3 py-1 bg-yellow-100 text-yellow-800 text-sm font-medium rounded-full">
                            <i class="fas fa-user-graduate mr-1"></i> Untuk Siswa
                        </span>
                    @endif
                </div>
            </div>
        ...
        <div class="md:col-span-1">
            ...
            <div class="bg-blue-50 p-4 rounded-lg shadow-sm mt-6">
                <h4 class="text-lg font-medium text-gray-900 mb-3">Informasi Event</h4>
                <div class="flex items-center mb-3">
                    ...
                    <div>
                        ...
                        <div class="font-medium">{{ $event->start_date->format('d M Y, H:i') }}</div>
                    </div>
                </div>
                
                <div class="flex items-center mb-3">
                    <div class="w-10 h-10 flex items-center justify-center bg-green-100 rounded-full mr-3">
                        <i class="fas fa-hourglass-end text-green-600"></i>
                    </div>
                    <div>
                        <div class="text-sm text-gray-600">Tanggal Selesai</div>
                        <div class="font-medium">{{ $event->end_date->format('d M Y, H:i') }}</div>
                    </div>
                </div>
    ...
    <div class="mt-8 pt-6 border-t">
        <a href="{{ route('siswa.events.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white font-medium py-2 px-6 rounded-md">
