...
<head>
    ...
    <title>Akses Ditolak - SMAN 1 GIRSIP</title>
...
<body class="min-h-screen flex flex-col items-center justify-center p-4">
    <div class="max-w-md w-full mx-auto">
        <div class="text-center mb-8 float-animation">
            <div class="inline-flex items-center justify-center h-24 w-24 bg-red-100 text-red-600 rounded-full">
        ...
        <div class="glass-card rounded-xl p-8 text-center">
            ...
            <p class="text-gray-600 mb-8">Anda tidak memiliki izin untuk mengakses halaman ini. Silakan kembali ke halaman beranda atau logout.</p>
        ...
        <p class="text-center text-gray-500 text-sm mt-8">
            &copy; {{ date('Y') }} SMAN 1 Girsip. Sistem Informasi Akademik
        </p>
    </div>
</body>
</html>
