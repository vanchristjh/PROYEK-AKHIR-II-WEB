...
<?php $__env->startSection('title', 'Hasil Kuis'); ?>

<?php $__env->startSection('header', 'Hasil Kuis'); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="relative z-10">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                <div class="mb-4 md:mb-0">
                    ...
                    <h2 class="text-2xl font-bold">Hasil Kuis: <?php echo e($quiz->title); ?></h2>
                ...
                <div class="flex space-x-2">
                    <a href="<?php echo e(route('guru.quizzes.show', $quiz->id)); ?>" class="flex items-center px-4 py-2 transition-colors rounded-lg shadow-sm bg-white/10 hover:bg-white/20 backdrop-blur-sm">
        ...
        <div class="p-4 bg-white border border-gray-100 shadow-sm rounded-xl">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <div class="text-xl font-bold text-gray-800"><?php echo e($attempts->count()); ?></div>
                    <div class="text-xs text-gray-500">dari <?php echo e($totalStudents ?? 0); ?> siswa</div>
                </div>
            </div>
        </div>
        ...
        <div class="p-4 bg-white border border-gray-100 shadow-sm rounded-xl">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <div class="text-xl font-bold text-gray-800"><?php echo e(number_format($averageScore ?? 0, 1)); ?></div>
                    <div class="text-xs text-gray-500">Nilai kelulusan: <?php echo e($quiz->passing_grade ?? 70); ?></div>
                </div>
            </div>
        </div>
        ...
        <div class="p-4 bg-white border border-gray-100 shadow-sm rounded-xl">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <div class="text-xl font-bold text-gray-800"><?php echo e($passRate ?? 0); ?>%</div>
                    <div class="text-xs text-gray-500"><?php echo e($passedCount ?? 0); ?> siswa lulus</div>
                </div>
            </div>
        </div>
        ...
        <div class="p-4 bg-white border border-gray-100 shadow-sm rounded-xl">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <div class="text-xl font-bold text-gray-800"><?php echo e($highestScore ?? 0); ?></div>
                    <div class="text-xs text-gray-500"><?php echo e($highestScoreStudent ?? '-'); ?></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="p-6">
            ...
            <div class="grid grid-cols-1 gap-4 mb-6 text-center md:grid-cols-5">
                <div class="p-3 border border-red-100 rounded-lg bg-red-50">
                    ...
                    <div class="text-lg font-bold text-red-600"><?php echo e($scoreDistribution[0] ?? 0); ?></div>
                ...
                <div class="p-3 border border-orange-100 rounded-lg bg-orange-50">
                    ...
                    <div class="text-lg font-bold text-orange-600"><?php echo e($scoreDistribution[1] ?? 0); ?></div>
                ...
                <div class="p-3 border border-yellow-100 rounded-lg bg-yellow-50">
                    ...
                    <div class="text-lg font-bold text-yellow-600"><?php echo e($scoreDistribution[2] ?? 0); ?></div>
                ...
                <div class="p-3 border border-blue-100 rounded-lg bg-blue-50">
                    ...
                    <div class="text-lg font-bold text-blue-600"><?php echo e($scoreDistribution[3] ?? 0); ?></div>
                ...
                <div class="p-3 border border-green-100 rounded-lg bg-green-50">
                    ...
                    <div class="text-lg font-bold text-green-600"><?php echo e($scoreDistribution[4] ?? 0); ?></div>
    ...
    <div class="p-4 mb-6 bg-white border border-gray-100 shadow-sm rounded-xl">
        <form action="<?php echo e(route('guru.quizzes.results', $quiz->id)); ?>" method="GET" class="flex flex-col items-center justify-between gap-4 sm:flex-row">
            <div class="flex-1">
            ...
            <div class="flex items-center space-x-2">
                <select name="status" class="border-gray-300 rounded-lg focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                    ...
                    <option value="passed" <?php echo e(request('status') == 'passed' ? 'selected' : ''); ?>>Lulus</option>
                    <option value="failed" <?php echo e(request('status') == 'failed' ? 'selected' : ''); ?>>Tidak Lulus</option>
                </select>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php $__empty_1 = true; $__currentLoopData = $attempts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attempt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="flex items-center justify-center w-10 h-10 text-gray-500 bg-gray-200 rounded-full">
                                        <?php echo e(strtoupper(substr($attempt->student->name ?? 'U', 0, 1))); ?>

                                    </div>
                                    <div class="ml-3">
                                        <div class="text-sm font-medium text-gray-900"><?php echo e($attempt->student->name ?? 'Unknown'); ?></div>
                                        <div class="text-xs text-gray-500"><?php echo e($attempt->student->email ?? '-'); ?></div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900"><?php echo e($attempt->student->classroom->name ?? '-'); ?></div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium <?php echo e($attempt->score >= ($quiz->passing_grade ?? 70) ? 'text-green-600' : 'text-red-600'); ?>">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <?php if($attempt->score >= ($quiz->passing_grade ?? 70)): ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900"><?php echo e($attempt->created_at ? $attempt->created_at->format('d M Y') : '-'); ?></div>
                                <div class="text-xs text-gray-500"><?php echo e($attempt->created_at ? $attempt->created_at->format('H:i') : '-'); ?></div>
                                <div class="text-xs text-gray-500">Durasi: <?php echo e($attempt->duration_minutes ?? '-'); ?> menit</div>
                            </td>
                            <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                <a href="<?php echo e(route('guru.quiz-attempts.show', $attempt->id)); ?>" class="px-2 py-1 text-blue-600 rounded hover:text-blue-900 bg-blue-50 hover:bg-blue-100">
    ...
    <!-- Export Buttons -->    <div class="flex justify-end mb-8">
        <a href="<?php echo e(route('guru.quizzes.export', ['quiz' => $quiz->id, 'format' => 'pdf'])); ?>" class="inline-flex items-center px-4 py-2 ml-2 text-white transition-colors bg-red-600 rounded-lg hover:bg-red-700">
            <i class="mr-2 fas fa-file-pdf"></i> Export PDF
        </a>
        <a href="<?php echo e(route('guru.quizzes.export', ['quiz' => $quiz->id, 'format' => 'excel'])); ?>" class="inline-flex items-center px-4 py-2 ml-2 text-white transition-colors bg-green-600 rounded-lg hover:bg-green-700">
            <i class="mr-2 fas fa-file-excel"></i> Export Excel
        </a>
    </div>

    <!-- Pagination -->
    <?php if(isset($attempts) && $attempts->hasPages()): ?>
        <div class="px-4">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const data = [
            <?php echo e($scoreDistribution[0] ?? 0); ?>,
            <?php echo e($scoreDistribution[1] ?? 0); ?>,
            <?php echo e($scoreDistribution[2] ?? 0); ?>,
            <?php echo e($scoreDistribution[3] ?? 0); ?>,
            <?php echo e($scoreDistribution[4] ?? 0); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SEMUA TENTANG KULIAH\SEMESTER 4\PA2\IMPLEMENTASI NEW\sman1-girsip\resources\views/guru/quizzes/results.blade.php ENDPATH**/ ?>