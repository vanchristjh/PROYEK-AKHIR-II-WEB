...
<?php $__env->startSection('header', 'Materi Pembelajaran'); ?>
            ...
            <div class="p-5">
                <div class="flex items-start space-x-3">
                    <div class="file-icon rounded-lg bg-gray-100/80 flex-shrink-0">
                        <i class="fas fa-<?php echo e($icon); ?> text-xl <?php echo e($fileColor); ?>"></i>
                    </div>
                    <div>
                        <h3 class="font-semibold text-gray-900 mb-1"><?php echo e($material->title); ?></h3>
                        ...
                        <p class="text-gray-600 text-sm mb-4 line-clamp-3"><?php echo e($material->description ?? 'Tidak ada deskripsi tersedia'); ?></p>
                        <a href="<?php echo e(route('siswa.materials.show', $material->id)); ?>" class="inline-flex items-center px-3 py-1.5 bg-purple-100 text-purple-700 rounded-lg hover:bg-purple-200 transition-colors text-sm font-medium">
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SEMUA TENTANG KULIAH\SEMESTER 4\PA2\IMPLEMENTASI NEW\sman1-girsip\resources\views/siswa/materials/index.blade.php ENDPATH**/ ?>