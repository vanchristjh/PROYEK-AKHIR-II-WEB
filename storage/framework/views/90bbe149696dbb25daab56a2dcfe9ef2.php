...
<?php $__env->startSection('header', 'Nilai'); ?>

<?php $__env->startSection('navigation'); ?>
    <li>
        <a href="<?php echo e(route('siswa.dashboard')); ?>" class="sidebar-item flex items-center rounded-lg px-4 py-2.5 group relative text-indigo-100 hover:text-white transition-all duration-200">
    ...
    <li>
        <a href="<?php echo e(route('siswa.schedule.index')); ?>" class="sidebar-item flex items-center rounded-lg px-4 py-2.5 group relative text-indigo-100 hover:text-white transition-all duration-200">
    ...
    <li>
        <a href="<?php echo e(route('siswa.assignments.index')); ?>" class="sidebar-item flex items-center rounded-lg px-4 py-2.5 group relative text-indigo-100 hover:text-white transition-all duration-200">
            <div class="p-1.5 rounded-lg bg-indigo-700/50 group-hover:bg-blue-700/50 transition-all duration-200">
    ...
    <li>
        <a href="<?php echo e(route('siswa.material.index')); ?>" class="sidebar-item flex items-center rounded-lg px-4 py-2.5 group relative text-indigo-100 hover:text-white transition-all duration-200">
    ...
    <li>
        <a href="<?php echo e(route('siswa.grades.index')); ?>" class="sidebar-item sidebar-active flex items-center rounded-lg px-4 py-2.5 group relative text-white">
    ...
    <li>
        <a href="<?php echo e(route('siswa.announcements.index')); ?>" class="sidebar-item flex items-center rounded-lg px-4 py-2.5 group relative text-indigo-100 hover:text-white transition-all duration-200">
                ...
                <div class="flex items-center gap-6">
                    <div class="text-center">
                        <div class="text-3xl font-bold text-purple-600">
                            <?php echo e(number_format($averageScore ?? 0, 1)); ?>
                    ...
                    <div class="text-center">
                        <div class="text-3xl font-bold text-indigo-600">
                            <?php echo e(isset($submissions) && is_object($submissions) ? $submissions->count() : 0); ?>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200 border border-gray-200 rounded-lg">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php $__empty_1 = true; $__currentLoopData = $submissions ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $submission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>                    <tr class="hover:bg-gray-50 transition-all">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-gray-900"><?php echo e($submission->assignment->title ?? 'Judul tidak tersedia'); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-600">
                                <?php if($submission->assignment && $submission->assignment->subject): ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-600"><?php echo e($submission->submitted_at ? $submission->submitted_at->format('d M Y, H:i') : 'Waktu tidak tersedia'); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="px-3 py-1 inline-flex text-sm leading-5 font-semibold rounded-full 
                                <?php echo e($submission->score >= 85 ? 'bg-green-100 text-green-800' : 
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <a href="<?php echo e(route('siswa.grades.show', $submission)); ?>" class="text-indigo-600 hover:text-indigo-900 bg-indigo-50 hover:bg-indigo-100 px-2.5 py-1.5 rounded-md transition-colors">
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SEMUA TENTANG KULIAH\SEMESTER 4\PA2\IMPLEMENTASI NEW\sman1-girsip\resources\views/siswa/grades/index.blade.php ENDPATH**/ ?>