...
<?php $__env->startSection('title', 'Detail Kuis'); ?>

<?php $__env->startSection('header', 'Detail Kuis'); ?>
                ...
                <div class="mb-4 md:mb-0">
                    <div class="flex items-center mb-2">
                        <span class="inline-flex items-center px-3 py-1 mr-2 text-xs font-semibold text-yellow-800 bg-yellow-100 border border-yellow-200 rounded-full">
                            <i class="mr-1 fas fa-book"></i> <?php echo e($quiz->subject->name ?? 'Tidak ada mata pelajaran'); ?>
                    ...
                    <h2 class="text-2xl font-bold"><?php echo e($quiz->title); ?></h2>
                    <p class="mt-1 text-yellow-100">
                        <i class="mr-1 fas fa-calendar-alt"></i> 
                        <?php echo e($quiz->start_time ? \Carbon\Carbon::parse($quiz->start_time)->format('d M Y, H:i') : 'Tidak diatur'); ?> - 
                        <?php echo e($quiz->end_time ? \Carbon\Carbon::parse($quiz->end_time)->format('d M Y, H:i') : 'Tidak diatur'); ?>

                    </p>
                </div>
                <div class="flex space-x-2">
                    <a href="<?php echo e(route('guru.quizzes.edit', $quiz->id)); ?>" class="flex items-center px-4 py-2 transition-colors rounded-lg shadow-sm bg-white/10 hover:bg-white/20 backdrop-blur-sm">
                        <i class="mr-2 fas fa-edit"></i> Edit Kuis
                    </a>
                    <a href="<?php echo e(route('guru.quizzes.index')); ?>" class="flex items-center px-4 py-2 transition-colors rounded-lg shadow-sm bg-white/10 hover:bg-white/20 backdrop-blur-sm">
        ...
        <div class="lg:col-span-2">
            <div class="mb-6 overflow-hidden bg-white border shadow-sm rounded-xl border-gray-100/50">
                <div class="p-6">
                    ...
                    <div class="mb-6 prose max-w-none">
                        <p class="text-gray-700"><?php echo e($quiz->description ?? 'Tidak ada deskripsi'); ?></p>
                    </div>
                        ...
                        <div class="p-4 border border-gray-100 rounded-lg bg-gray-50">
                            ...
                            <ul class="space-y-2 text-sm">
                                <li class="flex justify-between">
                                    ...
                                    <span class="font-medium"><?php echo e($quiz->duration ?? 0); ?> menit</span>
                                </li>
                                <li class="flex justify-between">
                                    <span class="text-gray-600">Waktu Mulai:</span>
                                    <span class="font-medium"><?php echo e($quiz->start_time ? \Carbon\Carbon::parse($quiz->start_time)->format('d M Y, H:i') : 'Tidak diatur'); ?></span>
                                </li>
                                <li class="flex justify-between">
                                    <span class="text-gray-600">Waktu Berakhir:</span>
                                    <span class="font-medium"><?php echo e($quiz->end_time ? \Carbon\Carbon::parse($quiz->end_time)->format('d M Y, H:i') : 'Tidak diatur'); ?></span>
                                </li>
                                <li class="flex justify-between">
                        ...
                        <div class="p-4 border border-gray-100 rounded-lg bg-gray-50">
                            ...
                            <ul class="space-y-2 text-sm">
                                <li class="flex justify-between">
                                    ...
                                    <span class="font-medium"><?php echo e($quiz->passing_grade ?? '70'); ?></span>
                                </li>
                                <li class="flex justify-between">
                                    <span class="text-gray-600">Percobaan Maksimum:</span>
                                    <span class="font-medium"><?php echo e($quiz->max_attempts ?? '1'); ?> kali</span>
                                </li>
                                <li class="flex justify-between">
                                    <span class="text-gray-600">Acak Soal:</span>
                                    <span class="font-medium"><?php echo e($quiz->is_random ? 'Ya' : 'Tidak'); ?></span>
                                </li>
                                <li class="flex justify-between">
                                    <span class="text-gray-600">Tampilkan Jawaban:</span>
                                    <span class="font-medium"><?php echo e($quiz->show_answers ? 'Ya' : 'Tidak'); ?></span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="mt-6">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <?php $__empty_1 = true; $__currentLoopData = $quiz->classrooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $classroom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <span class="inline-flex items-center px-3 py-1 text-xs font-medium text-indigo-800 bg-indigo-100 border border-indigo-200 rounded-full">
                                    <i class="mr-1 fas fa-users"></i> <?php echo e($classroom->name); ?>
            ...
            <div class="overflow-hidden bg-white border shadow-sm rounded-xl border-gray-100/50">
                <div class="flex items-center justify-between p-6 border-b border-gray-100">
                    ...
                    </h3>                    <a href="<?php echo e(route('guru.quizzes.questions.create', ['quiz' => $quiz->id])); ?>" class="flex items-center px-4 py-2 text-white transition-colors bg-purple-600 rounded-lg hover:bg-purple-700">
                ...
                <div class="divide-y divide-gray-100">
                            ...
                            <div class="flex items-start justify-between">
                                <div class="flex-1">
                                    <div class="flex items-center mb-2">
                                        ...
                                        <div class="px-2.5 py-1 rounded-md bg-<?php echo e($question->type == 'multiple_choice' ? 'blue' : ($question->type == 'true_false' ? 'green' : 'amber')); ?>-100 text-<?php echo e($question->type == 'multiple_choice' ? 'blue' : ($question->type == 'true_false' ? 'green' : 'amber')); ?>-800 text-xs font-medium">
                                            <?php echo e($question->type == 'multiple_choice' ? 'Pilihan Ganda' : ($question->type == 'true_false' ? 'Benar/Salah' : 'Essay')); ?>

                                        </div>
                                    </div>

                                    <div class="mb-4 prose max-w-none">
                                        <h4 class="text-base font-medium text-gray-800"><?php echo e($question->content); ?></h4>
                                        
                                        <?php if($question->type == 'multiple_choice'): ?>
                                            <div class="mt-2 pl-4 space-y-1.5">
                                                <?php $__currentLoopData = $question->options ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="flex items-center">
                                                        <div class="w-5 h-5 rounded-full <?php echo e($option['is_correct'] ? 'bg-green-500' : 'bg-gray-200'); ?> text-white flex items-center justify-center text-xs mr-2">
                                                            <?php echo e($option['is_correct'] ? '✓' : ''); ?>

                                                        </div>
                                                        <span class="text-sm <?php echo e($option['is_correct'] ? 'font-medium text-green-700' : 'text-gray-700'); ?>">
                                        ...
                                        <?php elseif($question->type == 'true_false'): ?>
                                            <div class="flex pl-4 mt-2 space-x-4">
                                                <div class="flex items-center">
                                                    <div class="w-5 h-5 rounded-full <?php echo e($question->answer == 'true' ? 'bg-green-500' : 'bg-gray-200'); ?> text-white flex items-center justify-center text-xs mr-2">
                                                        <?php echo e($question->answer == 'true' ? '✓' : ''); ?>

                                                    </div>
                                                    <span class="text-sm <?php echo e($question->answer == 'true' ? 'font-medium text-green-700' : 'text-gray-700'); ?>">
                                                        Benar
                                                    </span>
                                                </div>
                                                <div class="flex items-center">
                                                    <div class="w-5 h-5 rounded-full <?php echo e($question->answer == 'false' ? 'bg-green-500' : 'bg-gray-200'); ?> text-white flex items-center justify-center text-xs mr-2">
                                                        <?php echo e($question->answer == 'false' ? '✓' : ''); ?>

                                                    </div>
                                                    <span class="text-sm <?php echo e($question->answer == 'false' ? 'font-medium text-green-700' : 'text-gray-700'); ?>">
                                                        Salah
                                                    </span>
                                                </div>
                                            </div>
                                        <?php elseif($question->type == 'essay'): ?>
                                            <div class="pl-4 mt-2">
                                                ...
                                                <?php if($question->answer_key): ?>
                                                    <div class="mt-2">
                                                        <span class="text-xs font-medium text-gray-600">Kunci Jawaban / Kata Kunci:</span>
                                                        <p class="text-sm text-green-700"><?php echo e($question->answer_key); ?></p>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                        <?php endif; ?>
                                    ...
                                    <div class="flex items-center text-xs text-gray-500">
                                        <span class="flex items-center">
                                            ...
                                            Poin: <?php echo e($question->score ?? 1); ?>

                                        </span>
                                    </div>
                                </div>

                                <div class="flex ml-4 space-x-2">                                    <a href="<?php echo e(route('guru.quizzes.questions.edit', ['quiz' => $quiz->id, 'question' => $question->id])); ?>" class="p-2 text-gray-500 transition-colors hover:text-blue-600">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form action="<?php echo e(route('guru.questions.destroy', $question->id)); ?>" method="POST" class="inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus soal ini?')">
                                        <?php echo csrf_field(); ?>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="p-8 text-center">
                            ...
                            <p class="mb-6 text-gray-500">Anda belum menambahkan soal untuk kuis ini.</p>                            <a href="<?php echo e(route('guru.quizzes.questions.create', ['quiz' => $quiz->id])); ?>" class="inline-flex items-center px-4 py-2 text-white transition-colors bg-purple-600 rounded-lg hover:bg-purple-700">
        ...
        <div>
                    ...
                    <div class="space-y-4">
                        <div class="p-4 border border-gray-100 rounded-lg bg-gray-50">
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <span class="font-medium text-blue-600"><?php echo e($quiz->attempts_count ?? 0); ?> / <?php echo e($quiz->total_students ?? 0); ?></span>
                            </div>
                            <div class="w-full h-2 bg-gray-200 rounded-full">
                                <div class="h-2 bg-blue-600 rounded-full" style="width: <?php echo e($quiz->total_students ? ($quiz->attempts_count / $quiz->total_students) * 100 : 0); ?>%"></div>
                            </div>
                            <p class="mt-2 text-xs text-gray-500">
                                <?php echo e($quiz->total_students ? round(($quiz->attempts_count / $quiz->total_students) * 100) : 0); ?>% siswa telah mengerjakan kuis
                            </p>
                        </div>
                        ...
                        <div class="p-4 border border-gray-100 rounded-lg bg-gray-50">
                            <div class="flex items-center justify-between mb-1">
                                ...
                                <span class="text-<?php echo e(($quiz->average_score ?? 0) >= ($quiz->passing_grade ?? 70) ? 'green' : 'red'); ?>-600 font-medium">
                                    <?php echo e(number_format($quiz->average_score ?? 0, 1)); ?>

                                </span>
                            </div>
                            <div class="w-full h-2 mb-2 bg-gray-200 rounded-full">
                                <div class="bg-<?php echo e(($quiz->average_score ?? 0) >= ($quiz->passing_grade ?? 70) ? 'green' : 'red'); ?>-600 h-2 rounded-full" style="width: <?php echo e(min(($quiz->average_score ?? 0), 100)); ?>%"></div>
                            </div>
                            <div class="flex justify-between text-xs">
                                <span class="text-gray-500">0</span>
                                <span class="font-medium text-gray-600">Nilai kelulusan: <?php echo e($quiz->passing_grade ?? 70); ?></span>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="p-4 text-center border border-green-100 rounded-lg bg-green-50">
                                ...
                                <div class="text-xl font-bold text-green-700"><?php echo e($quiz->passed_count ?? 0); ?></div>
                            ...
                            <div class="p-4 text-center border border-red-100 rounded-lg bg-red-50">
                                ...
                                <div class="text-xl font-bold text-red-700"><?php echo e($quiz->failed_count ?? 0); ?></div>
            ...
            <div class="overflow-hidden bg-white border shadow-sm rounded-xl border-gray-100/50">
                <div class="p-6">
                    ...
                    <div class="space-y-3">
                        <a href="<?php echo e(route('guru.quizzes.results', $quiz->id)); ?>" class="block w-full py-3 px-4 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg hover:from-blue-600 hover:to-blue-700 transition-all duration-300 shadow-sm hover:shadow-md transform hover:-translate-y-0.5 flex items-center justify-center">
                            <i class="mr-2 fas fa-chart-bar"></i>
                            <span>Lihat Hasil Kuis</span>
                        </a>

                        <?php if(!$quiz->is_active): ?>                            <form action="<?php echo e(route('guru.quizzes.activate', ['quiz' => $quiz->id])); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                        ...
                        <?php else: ?>
                            <form action="<?php echo e(route('guru.quizzes.deactivate', ['quiz' => $quiz->id])); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                        ...
                        <form action="<?php echo e(route('guru.quizzes.destroy', $quiz->id)); ?>" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus kuis ini? Semua data terkait kuis ini akan dihapus secara permanen.')">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('DELETE'); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SEMUA TENTANG KULIAH\SEMESTER 4\PA2\IMPLEMENTASI NEW\sman1-girsip\resources\views/guru/quizzes/show.blade.php ENDPATH**/ ?>