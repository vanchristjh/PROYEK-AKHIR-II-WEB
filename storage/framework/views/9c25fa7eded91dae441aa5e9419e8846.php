...
<?php $__env->startSection('header', 'Edit Tugas'); ?>

<?php $__env->startSection('content'); ?>
<div class="container mx-auto px-4 py-6">
    <div class="mb-6">
        <a href="<?php echo e(route('guru.assignments.show', $assignment)); ?>" class="text-blue-600 hover:text-blue-900 inline-flex items-center">
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden border border-gray-200">
        ...
        <form action="<?php echo e(route('guru.assignments.update', $assignment)); ?>" method="POST" enctype="multipart/form-data" class="p-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="title" id="title" value="<?php echo e(old('title', $assignment->title)); ?>" 
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="datetime-local" name="deadline" id="deadline" 
                           value="<?php echo e(old('deadline', $assignment->deadline ? $assignment->deadline->format('Y-m-d\TH:i') : '')); ?>" 
                           class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                           required>
                            ...
                            <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="relative flex items-start">
                                    <div class="flex items-center h-5">
                                        <input type="checkbox" name="classes[]" value="<?php echo e($class->id); ?>" id="class-<?php echo e($class->id); ?>"
                                            class="h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                                            <?php echo e(in_array($class->id, old('classes', $selectedClasses)) ? 'checked' : ''); ?>>
                                    </div>
                                    <div class="ml-3 text-sm">
                                        <label for="class-<?php echo e($class->id); ?>" class="font-medium text-gray-700"><?php echo e($class->name); ?></label>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    ...
                    <?php if($assignment->file): ?>
                        <div class="flex items-center bg-gray-50 p-4 rounded-md border border-gray-200 mb-4">
                            <div class="p-2 bg-blue-100 text-blue-600 rounded-md mr-3">
                                ...
                                ?>
                                <i class="fas <?php echo e($iconClass); ?> <?php echo e($iconColor); ?>"></i>
                            </div>
                            <div class="flex-1">
                                <span class="text-gray-800 font-medium"><?php echo e(Str::afterLast($assignment->file, '/')); ?></span>
                                <?php if(Storage::exists($assignment->file) && ($size = Storage::size($assignment->file))): ?>
                                    <span class="text-xs text-gray-500 ml-2">(<?php echo e(round($size / 1024 / 1024, 2)); ?> MB)</span>
                                <?php endif; ?>
                            </div>
                            <a href="<?php echo e(Storage::url($assignment->file)); ?>" target="_blank" class="text-blue-600 hover:text-blue-800 bg-blue-50 hover:bg-blue-100 px-3 py-1 rounded-md text-sm transition-colors mr-2">
                                <i class="fas fa-download mr-1"></i> Download
                            </a>
                            <a href="#" onclick="previewFile('<?php echo e(Storage::url($assignment->file)); ?>', '<?php echo e(strtolower($fileExt)); ?>')" class="text-green-600 hover:text-green-800 bg-green-50 hover:bg-green-100 px-3 py-1 rounded-md text-sm transition-colors">
                    ...
                    <div class="mt-1 flex items-center">
                        ...
                        <div class="ml-5 flex-1">
                            <input type="file" name="file" id="file" 
                                ...
                                <?php echo e(isset($assignment->file) && $assignment->file ? '' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mt-6 flex items-center justify-end">
                <a href="<?php echo e(route('guru.assignments.show', $assignment)); ?>" class="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 mr-3">
                    Batal
                </a>
...
<script>    document.addEventListener('DOMContentLoaded', function() {
        ...
        if(form) {
            form.addEventListener('submit', function(e) {                // Validate required fields
                ...
                if(deadline.value) {
                    const originalDeadline = "<?php echo e($assignment->deadline ? $assignment->deadline->format('Y-m-d\TH:i') : ''); ?>";
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SEMUA TENTANG KULIAH\SEMESTER 4\PA2\IMPLEMENTASI NEW\sman1-girsip\resources\views/guru/assignments/edit.blade.php ENDPATH**/ ?>