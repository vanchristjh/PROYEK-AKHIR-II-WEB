...
<?php $__env->startSection('header', 'Edit Mata Pelajaran'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="bg-gradient-to-r from-amber-500 to-amber-600 rounded-xl shadow-lg p-6 mb-6 text-white relative overflow-hidden animate-fade-in">
        ...
        <div class="relative">
            ...
            <p class="text-amber-100 mb-4">Ubah detail mata pelajaran "<?php echo e($subject->name); ?>"</p>
        ...
        <form action="<?php echo e(route('admin.subjects.update', $subject)); ?>" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="code" id="code" value="<?php echo e(old('code', $subject->code)); ?>" class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-amber-500 focus:border-amber-500 sm:text-sm" placeholder="Contoh: MTK01" required>
                </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="name" id="name" value="<?php echo e(old('name', $subject->name)); ?>" class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-amber-500 focus:border-amber-500 sm:text-sm" placeholder="Nama mata pelajaran" required>
                </div>
            </div>
                ...
                <div class="relative mt-1">
                    ...
                    <select name="teachers[]" id="teachers" multiple class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-amber-500 focus:border-amber-500 sm:text-sm" size="5">
                        <?php $__empty_1 = true; $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <option value="<?php echo e($teacher->id); ?>" <?php echo e(in_array($teacher->id, old('teachers', $selectedTeachers)) ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SEMUA TENTANG KULIAH\SEMESTER 4\PA2\IMPLEMENTASI NEW\sman1-girsip\resources\views/admin/subjects/edit.blade.php ENDPATH**/ ?>