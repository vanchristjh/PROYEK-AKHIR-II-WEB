...
<?php $__env->startSection('header', 'Tambah Kelas Baru'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100/50 transform transition hover:shadow-md">
        <div class="p-6">
            <form action="<?php echo e(route('admin.classrooms.store')); ?>" method="POST" class="animate-fade-in">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group mb-5">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <select name="grade_level" id="grade_level" 
                                ...
                                <option value="10" <?php echo e(old('grade_level') == '10' ? 'selected' : ''); ?>>Kelas 10</option>
                                <option value="11" <?php echo e(old('grade_level') == '11' ? 'selected' : ''); ?>>Kelas 11</option>
                                <option value="12" <?php echo e(old('grade_level') == '12' ? 'selected' : ''); ?>>Kelas 12</option>
                            </select>
                        </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group mb-5">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input type="text" name="academic_year" id="academic_year" value="<?php echo e(old('academic_year', date('Y').'/'.((int)date('Y')+1))); ?>" 
                                class="pl-10 w-full rounded-lg border-gray-300 focus:border-purple-500 focus:ring focus:ring-purple-200 focus:ring-opacity-50 transition-shadow duration-300" required>
                        </div>
                    ...
                    <div class="form-group mb-5">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <select name="homeroom_teacher_id" id="homeroom_teacher_id" 
                                ...
                                <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($teacher->id); ?>" <?php echo e(old('homeroom_teacher_id') == $teacher->id ? 'selected' : ''); ?>>
                                        <?php echo e($teacher->name); ?> <?php echo e(!empty($teacher->nip) ? '(' . $teacher->nip . ')' : ''); ?>
                        ...
                        <?php if($teachers->isEmpty()): ?>
                            <div class="mt-2 text-yellow-600 text-xs flex items-center">
                                ...
                                Tidak ada guru tersedia. <a href="<?php echo e(route('admin.users.create')); ?>" class="ml-1 text-purple-600 hover:underline">Tambah guru baru</a>
                            </div>
                        <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group mb-5">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input type="number" name="capacity" id="capacity" value="<?php echo e(old('capacity', 30)); ?>" min="1" 
                                class="pl-10 w-full rounded-lg border-gray-300 focus:border-purple-500 focus:ring focus:ring-purple-200 focus:ring-opacity-50 transition-shadow duration-300" required>
                        </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group mb-5">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input type="text" name="room_number" id="room_number" value="<?php echo e(old('room_number')); ?>" 
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group md:col-span-2 mt-4">
                        ...
                        <div class="bg-purple-50 p-5 rounded-xl border border-purple-100 max-h-64 overflow-y-auto">
                            <?php if(isset($subjects) && $subjects->isNotEmpty()): ?>
                                    ...
                                    <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex items-center p-2 rounded-lg hover:bg-purple-100/50 transition-colors">
                                            <input type="checkbox" id="subject-<?php echo e($subject->id); ?>" name="subjects[]" value="<?php echo e($subject->id); ?>" 
                                                ...
                                                <?php echo e((is_array(old('subjects')) && in_array($subject->id, old('subjects'))) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SEMUA TENTANG KULIAH\SEMESTER 4\PA2\IMPLEMENTASI NEW\sman1-girsip\resources\views/admin/classrooms/create.blade.php ENDPATH**/ ?>