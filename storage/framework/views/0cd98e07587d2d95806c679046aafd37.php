...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> - SMAN 1 Learning Management System</title>
    ...
    <div x-data="{ sidebarOpen: false }" class="flex h-screen overflow-hidden">
        ...
        <div :class="{'translate-x-0': sidebarOpen, '-translate-x-full': !sidebarOpen}" 
            ...
            <div class="flex items-center justify-between px-3">
                <a href="<?php echo e(route('guru.dashboard')); ?>" class="flex items-center space-x-3">
        ...
        <div class="flex-1 flex flex-col overflow-hidden lg:pl-64">
            ...
            <header class="bg-white shadow-sm">
                <div class="flex items-center justify-between h-16 px-6">
                    <div class="flex items-center">
                        ...
                        <h2 class="text-xl font-semibold text-gray-700 ml-3"><?php echo $__env->yieldContent('header', 'Dashboard Guru'); ?></h2>
                    </div>
                            ...
                            <button @click="open = !open" class="flex items-center space-x-2 focus:outline-none">
                                <div class="w-8 h-8 rounded-full bg-indigo-500 flex items-center justify-center text-white">
                                    <?php if(Auth::user()->avatar): ?>
                                        <img src="<?php echo e(asset('storage/'.Auth::user()->avatar)); ?>" class="w-8 h-8 rounded-full object-cover" alt="Profile">
                                    <?php else: ?>
                                        <span class="font-medium"><?php echo e(strtoupper(substr(Auth::user()->name, 0, 1))); ?></span>
                                    <?php endif; ?>
                                </div>
                                <span class="text-gray-700 hidden md:block"><?php echo e(Auth::user()->name); ?></span>
                                <i class="fas fa-chevron-down text-xs text-gray-400"></i>
                            </button>
                            
                            <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-50">                                <a href="<?php echo e(route('guru.profile.edit')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                    <i class="fas fa-user-circle mr-2 text-gray-500"></i>
                                    Profil
                                </a>
                                <a href="<?php echo e(route('guru.settings.index')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                    <i class="fas fa-cog mr-2 text-gray-500"></i>
                                    Pengaturan
                                </a>
                                <hr class="my-1 border-gray-200">
                                <form method="POST" action="<?php echo e(route('logout')); ?>" class="block w-full text-left">
                                    <?php echo csrf_field(); ?>
            ...
            <footer class="bg-white border-t border-gray-200 py-4 px-6">
                <div class="container mx-auto flex flex-col md:flex-row justify-between items-center">
                    <p class="text-sm text-gray-500">&copy; <?php echo e(date('Y')); ?> SMAN 1 GIRSIP - Sistem Informasi Arsip Digital</p>
                    <div class="mt-2 md:mt-0 flex items-center space-x-4 text-sm text-gray-500">
                        <a href="<?php echo e(route('guru.help')); ?>" class="hover:text-indigo-600 transition-colors">Bantuan</a>
                        <span class="text-gray-300">|</span>
                        <a href="<?php echo e(route('guru.settings.privacy')); ?>" class="hover:text-indigo-600 transition-colors">Privasi</a>
                        <span class="text-gray-300">|</span>
                        <a href="<?php echo e(route('guru.profile.show')); ?>" class="hover:text-indigo-600 transition-colors">Profil</a>
                    </div>
                </div>
            </footer>
        </div>
...
<?php /**PATH D:\SEMUA TENTANG KULIAH\SEMESTER 4\PA2\IMPLEMENTASI NEW\sman1-girsip\resources\views/layouts/guru.blade.php ENDPATH**/ ?>