...
<?php $__env->startSection('header', 'Detail Tugas'); ?>
...
<?php $__env->startSection('navigation'); ?>
    ...
    <li>
        <a href="<?php echo e(route('guru.assignments.index')); ?>" class="sidebar-item sidebar-active flex items-center rounded-lg px-4 py-2.5 group relative text-white">
    ...
    <li>
        <a href="<?php echo e(route('guru.grades.index')); ?>" class="sidebar-item flex items-center rounded-lg px-4 py-2.5 group relative text-indigo-100 hover:text-white transition-all duration-200">
    ...
    <li>
        <a href="<?php echo e(route('guru.announcements.index')); ?>" class="sidebar-item flex items-center rounded-lg px-4 py-2.5 group relative text-indigo-100 hover:text-white transition-all duration-200">
...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="mb-6">
        <a href="<?php echo e(route('guru.assignments.index')); ?>" class="text-blue-600 hover:text-blue-900 inline-flex items-center">
                        ...
                        <div>
                            <div class="flex items-center mb-2">
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-blue-100 text-blue-800 border border-blue-200 mr-2">
                                    <i class="fas fa-book mr-1"></i> <?php echo e($assignment->subject->name); ?>
                            ...
                            <h1 class="text-2xl font-bold text-gray-800 mb-2"><?php echo e($assignment->title); ?></h1>
                            <div class="flex flex-wrap gap-4 text-sm text-gray-600">
                                <div class="inline-flex items-center">
                                    <i class="fas fa-calendar-alt mr-1 text-gray-400"></i>
                                    <span>Dibuat: <?php echo e($assignment->created_at->format('d M Y')); ?></span>
                                </div>
                                <?php
                                ...
                                ?>
                                <div class="inline-flex items-center">
                                    <i class="fas fa-clock mr-1 <?php echo e($isExpired ? 'text-red-500' : 'text-gray-400'); ?>"></i>
                                    <span class="<?php echo e($isExpired ? 'text-red-500 font-medium' : ''); ?>">
                                        Deadline: <?php echo e($deadlineDate ? $deadlineDate->format('d M Y, H:i') : 'Tidak ada'); ?>

                                    </span>
                                </div>
                            </div>
                        </div>                        <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2">                            <a href="<?php echo e(route('guru.assignments.edit', $assignment)); ?>" class="bg-yellow-500 hover:bg-yellow-600 text-white px-4 py-2 rounded-lg flex items-center transition-colors">
                                <i class="fas fa-edit mr-2"></i> Edit                            </a>                            <a href="<?php echo e(route('guru.assignments.submissions.index', ['assignment' => $assignment])); ?>" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg flex items-center transition-colors"><i class="fas fa-clipboard-list mr-2"></i> Pengumpulan 
                                <span class="ml-1 bg-white text-blue-700 rounded-full h-5 w-5 flex items-center justify-center text-xs">
                                    <?php echo e($submissionStats['total'] ?? 0); ?>

                                </span>
                            </a>
                            <a href="<?php echo e(route('guru.assignments.batch-grade', $assignment)); ?>" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg flex items-center transition-colors">
                ...
                <div class="p-6">
                        ...
                        <div class="mb-8">
                            ...
                            <div class="flex items-center bg-blue-50 border border-blue-100 p-4 rounded-md">
                                <div class="p-2 bg-blue-100 rounded-md mr-4">
                                    ...
                                    ?>
                                    <i class="fas <?php echo e($iconClass); ?> <?php echo e($iconColor); ?> text-lg"></i>
                                </div>
                                <div class="flex-1">
                                    <p class="text-gray-700 font-medium mb-1"><?php echo e(Str::afterLast($assignment->file, '/')); ?></p>
                                    <p class="text-sm text-gray-500">File tugas yang diberikan kepada siswa</p>
                                    <?php if(Storage::exists($assignment->file) && ($size = Storage::size($assignment->file))): ?>
                                        <p class="text-xs text-gray-500"><?php echo e(round($size / 1024 / 1024, 2)); ?> MB</p>
                                    <?php endif; ?>
                                </div>
                                <div class="flex space-x-2">
                                    <a href="<?php echo e(Storage::url($assignment->file)); ?>" target="_blank" class="px-3 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors">
                                        <i class="fas fa-download mr-1"></i> Download
                                    </a>
                                    <a href="#" onclick="previewFile('<?php echo e(Storage::url($assignment->file)); ?>', '<?php echo e(strtolower($fileExt)); ?>')" class="px-3 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors">
                    ...
                    <div class="border-t border-gray-200 pt-6">
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
                            <?php if($assignment->class_id && $assignment->classes && !is_null($assignment->classes->id)): ?>
                                <div class="bg-gray-50 rounded-lg border border-gray-200 p-3 flex items-center">
                                    ...
                                    <span class="text-gray-700"><?php echo e($assignment->classes->name); ?></span>
                                </div>
                            <?php else: ?>
        ...
        <div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 mb-6 overflow-hidden">
                <div class="p-4 border-b border-gray-200 bg-gray-50 flex justify-between items-center">
                    ...
                    <div class="flex space-x-2">
                        <a href="<?php echo e(route('guru.assignments.submissions.export', $assignment)); ?>" class="px-3 py-1 text-sm text-white bg-green-500 rounded hover:bg-green-600 flex items-center">
                            <i class="fas fa-file-excel mr-1"></i>Excel
                        </a>
                        <a href="<?php echo e(route('guru.assignments.submissions.export-pdf', $assignment)); ?>" class="px-3 py-1 text-sm text-white bg-red-500 rounded hover:bg-red-600 flex items-center">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div class="bg-green-50 rounded-lg p-4 border border-green-100">
                            ...
                            <div class="text-2xl font-bold text-green-900"><?php echo e($submissionStats['total']); ?></div>
                        </div>
                        <div class="bg-yellow-50 rounded-lg p-4 border border-yellow-100">
                            <div class="text-yellow-800 text-sm font-medium mb-1">Sudah Dinilai</div>
                            <div class="text-2xl font-bold text-yellow-900"><?php echo e($submissionStats['graded']); ?></div>
                        </div>
                        <div class="bg-red-50 rounded-lg p-4 border border-red-100">
                            <div class="text-red-800 text-sm font-medium mb-1">Belum Mengumpulkan</div>
                            <div class="text-2xl font-bold text-red-900"><?php echo e($totalStudents - $submissionStats['total']); ?></div>
                        </div>
                    </div>
                    ...
                    <div class="mt-5">
                        ...
                        <div class="h-3 relative max-w-full rounded-full overflow-hidden bg-gray-200 mb-4">
                            <div class="h-full bg-green-500 absolute rounded-full" style="width: <?php echo e($submissionPercent); ?>%"></div>
                        </div>
                        <div class="text-sm text-gray-500 flex justify-between mb-4">
                            <div>Pengumpulan: <?php echo e($submissionPercent); ?>%</div>
                            <div><?php echo e($submissionStats['total']); ?>/<?php echo e($totalStudents); ?></div>
                        </div>
                        
                        <!-- Grading Progress Bar -->
                        <div class="h-3 relative max-w-full rounded-full overflow-hidden bg-gray-200 mb-4">
                            <div class="h-full bg-yellow-500 absolute rounded-full" style="width: <?php echo e($gradingPercent); ?>%"></div>
                        </div>
                        <div class="text-sm text-gray-500 flex justify-between">
                            <div>Penilaian: <?php echo e($gradingPercent); ?>%</div>
                            <div><?php echo e($submissionStats['graded']); ?>/<?php echo e($submissionStats['total']); ?></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 mb-6 overflow-hidden">
                ...
                <div class="p-6">
                    <?php if($assignment->submissions && $assignment->submissions->count() > 0): ?>
                        <div class="space-y-3">
                            <?php $__currentLoopData = $assignment->submissions->sortByDesc('created_at')->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $submission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center p-3 bg-gray-50 rounded-md border border-gray-200">
                                    ...
                                    <div class="ml-3 flex-1">
                                        <p class="text-sm font-medium text-gray-800"><?php echo e($submission->student->name ?? 'Siswa'); ?></p>
                                        <p class="text-xs text-gray-500"><?php echo e($submission->created_at->diffForHumans()); ?></p>
                                    </div>
                                    <?php if($submission->score): ?>
                                        <span class="bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-full">
                                            Nilai: <?php echo e($submission->score); ?>
                        ...
                        <?php if($assignment->submissions->count() > 3): ?>
                            <div class="mt-3 text-center">
                                <a href="<?php echo e(route('guru.assignments.submissions.index', $assignment)); ?>" class="text-sm text-blue-600 hover:text-blue-800">
                                    Lihat semua pengumpulan (<?php echo e($assignment->submissions->count()); ?>)
                                </a>
                            </div>
                        <?php endif; ?>
                    <?php else: ?>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                <div class="p-4 border-b border-gray-200 bg-gray-50">
                ...
                </div>                <div class="p-4 space-y-3">                    <a href="<?php echo e(route('guru.assignments.submissions.index', $assignment)); ?>" 
                    ...
                    <a href="<?php echo e(route('guru.assignments.statistics', $assignment)); ?>" 
                    ...
                    <form action="<?php echo e(route('guru.assignments.destroy', $assignment)); ?>" method="POST" 
                        ...
                        <button type="button" id="delete-assignment-btn" class="w-full flex items-center p-3 bg-red-50 hover:bg-red-100 rounded-lg text-red-700 transition-colors <?php echo e($submissionStats['total'] > 0 ? 'opacity-50 cursor-not-allowed' : ''); ?>" 
                                <?php echo e($submissionStats['total'] > 0 ? 'disabled' : ''); ?>>
                            <i class="fas fa-trash-alt mr-3"></i>
                            <span>Hapus Tugas</span>
                        </button>
                        <?php if($submissionStats['total'] > 0): ?>
...
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SEMUA TENTANG KULIAH\SEMESTER 4\PA2\IMPLEMENTASI NEW\sman1-girsip\resources\views/guru/assignments/show.blade.php ENDPATH**/ ?>