...
<?php $__env->startSection('title', 'Daftar Kuis'); ?>
...
<div class="breadcrumb mb-4">
    <a href="<?php echo e(route('siswa.dashboard')); ?>" class="hover:text-indigo-800 transition-colors">
...
<div class="main-content">
    ...
    <div class="empty-state">
        ...
        <a href="<?php echo e(route('siswa.dashboard')); ?>" class="btn btn-primary">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="quiz-card" style="animation-delay: <?php echo e(100 + ($index * 100)); ?>ms">
            <div class="card-content">
                <div class="flex justify-between items-start mb-3">
                    <h5 class="card-title text-lg"><?php echo e($quiz->title); ?></h5>
                    <?php
                ...
                <p class="text-gray-600 text-sm mb-3 flex items-center">
                    <i class="fas fa-clock mr-2 text-indigo-400"></i> Durasi: <?php echo e($quiz->time_limit ?? 'Tidak ada batas'); ?>

                </p>
                <div class="quiz-description"><?php echo e(\Illuminate\Support\Str::limit($quiz->description, 120)); ?></div>
                
                <div class="flex justify-between items-center mt-4">
                    <?php if($quiz->end_date): ?>
                    <small class="countdown flex items-center">
                        <i class="fas fa-hourglass-half mr-1 text-amber-500"></i>
                        <?php if($quiz->end_date > now()): ?>
                            <span>Berakhir: <?php echo e($quiz->end_date->format('d M Y, H:i')); ?></span>
                        <?php else: ?>
            ...
            <div class="card-footer">
                <div class="flex flex-wrap gap-2 mb-3">
                    ...
                    <span class="subject-badge">
                        <i class="fas fa-book"></i> <?php echo e($quiz->subject->name); ?>

                    </span>
                    <?php endif; ?>
                    <?php if($quiz->teacher): ?>
                    <span class="teacher-badge">
                        <i class="fas fa-user"></i> <?php echo e($quiz->teacher->name); ?>
                ...
                <div class="flex justify-end mt-3">
                    <?php if($isCompleted): ?>
                        <a href="<?php echo e(route('siswa.quizzes.results', $quiz->id)); ?>" class="btn btn-outline">
                            <i class="fas fa-chart-bar mr-1"></i> Lihat Hasil
                        </a>
                    <?php elseif(!$isExpired): ?>
                        <a href="<?php echo e(route('siswa.quizzes.show', $quiz->id)); ?>" class="btn btn-primary">
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SEMUA TENTANG KULIAH\SEMESTER 4\PA2\IMPLEMENTASI NEW\sman1-girsip\resources\views/siswa/quizzes/index.blade.php ENDPATH**/ ?>