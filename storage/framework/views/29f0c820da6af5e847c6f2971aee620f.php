...
<?php $__env->startSection('title', 'Buat Kuis Baru'); ?>

<?php $__env->startSection('header', 'Buat Kuis Baru'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="mb-6">
        <a href="<?php echo e(route('guru.quizzes.index')); ?>" class="inline-flex items-center text-yellow-600 hover:text-yellow-800 transition-colors">
    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100/50 transform transition hover:shadow-md">
        <div class="p-6">
            <form action="<?php echo e(route('guru.quizzes.store')); ?>" method="POST" class="animate-fade-in" enctype="multipart/form-data" id="quizForm">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group mb-5 md:col-span-2">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            <textarea name="description" id="description" rows="3" 
                                class="w-full rounded-lg border-gray-300 focus:border-yellow-500 focus:ring focus:ring-yellow-200 focus:ring-opacity-50 transition-shadow duration-300"><?php echo e(old('description')); ?></textarea>
                        </div>
                                ...
                                <?php $__currentLoopData = $classrooms ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $classroom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center">
                                        <input type="checkbox" id="classroom_<?php echo e($classroom->id); ?>" name="classroom_id[]" value="<?php echo e($classroom->id); ?>"
                                            ...
                                            <?php echo e(in_array($classroom->id, old('classroom_id', [])) ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group mb-5">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input type="number" name="duration" id="duration" value="<?php echo e(old('duration', 30)); ?>" min="1" 
                                class="pl-10 w-full rounded-lg border-gray-300 focus:border-yellow-500 focus:ring focus:ring-yellow-200 focus:ring-opacity-50 transition-shadow duration-300" required>
                        </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group mb-5">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input type="number" name="max_attempts" id="max_attempts" value="<?php echo e(old('max_attempts', 1)); ?>" min="1" 
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group mb-5">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input type="number" name="passing_grade" id="passing_grade" value="<?php echo e(old('passing_grade', 70)); ?>" min="0" max="100" 
                                class="pl-10 w-full rounded-lg border-gray-300 focus:border-yellow-500 focus:ring focus:ring-yellow-200 focus:ring-opacity-50 transition-shadow duration-300">
                        </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mt-1 bg-white rounded-lg border border-gray-300 px-4 py-3 space-y-3">
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input id="is_random" name="is_random" type="checkbox" value="1" <?php echo e(old('is_random') ? 'checked' : ''); ?>
                            ...
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input id="show_answers" name="show_answers" type="checkbox" value="1" <?php echo e(old('show_answers') ? 'checked' : ''); ?>
                            ...
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input id="is_active" name="is_active" type="checkbox" value="1" <?php echo e(old('is_active', '1') ? 'checked' : ''); ?>
                ...
                <div class="border-t border-gray-200 mt-8 pt-5">
                    <div class="flex justify-end">
                        <a href="<?php echo e(route('guru.quizzes.index')); ?>" class="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-colors duration-300">
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SEMUA TENTANG KULIAH\SEMESTER 4\PA2\IMPLEMENTASI NEW\sman1-girsip\resources\views/guru/quizzes/create.blade.php ENDPATH**/ ?>