...
<?php $__env->startSection('header', 'Pengumuman'); ?>
...
<?php $__env->startSection('navigation'); ?>
    ...
    <li>
        <a href="<?php echo e(route('siswa.assignments.index')); ?>" class="sidebar-item flex items-center rounded-lg px-4 py-3 text-indigo-100 hover:text-white transition-all duration-200">
    ...
    <?php if(Route::has('siswa.attendance.index')): ?>
    <li>
        <a href="<?php echo e(route('siswa.attendance.index')); ?>" class="sidebar-item flex items-center rounded-lg px-4 py-3 text-indigo-100 hover:text-white transition-all duration-200">
    ...
    <?php endif; ?>
    <li>
        <a href="<?php echo e(route('siswa.announcements.index')); ?>" class="sidebar-item sidebar-active flex items-center rounded-lg px-4 py-3 text-white">
...
<?php $__env->startSection('content'); ?>
                ...
                <div class="mt-4 md:mt-0 md:ml-2 flex items-center gap-3">
                    <div class="bg-white/15 rounded-lg px-3 py-2 backdrop-blur-sm flex items-center">
                        ...
                        <span class="text-sm font-medium">
                            <?php echo e($importantCount ?? 0); ?> Pengumuman Penting
                        </span>
                    </div>
                </div>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-sm p-4 mb-6 border border-gray-100/80">
        <form action="<?php echo e(route('siswa.announcements.index')); ?>" method="GET" class="flex flex-col sm:flex-row items-center justify-between gap-4">
    ...
    <div class="grid grid-cols-1 gap-6 mb-8">
        <?php $__empty_1 = true; $__currentLoopData = $announcements ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $announcement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="bg-white rounded-xl shadow-sm overflow-hidden border <?php echo e($announcement->is_important ? 'border-red-200' : 'border-gray-100/80'); ?> hover:shadow-md transition-all duration-300 group">
                <!-- Important Badge -->
                ...
                <div class="p-5">
                    <div class="flex flex-col md:flex-row">
                        ...
                        <div class="flex-shrink-0 mb-4 md:mb-0">
                            <div class="inline-flex items-center justify-center h-14 w-14 rounded-xl <?php echo e($announcement->is_important ? 'bg-red-100 text-red-600 animate-pulse-slow' : 'bg-orange-100 text-orange-600'); ?>">
                        ...
                        <div class="md:ml-5 flex-1">
                            <div class="flex flex-wrap items-center gap-2 mb-2">
                                ...
                                <?php endif; ?>
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($announcement->isNew() ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'); ?>">
                                    <?php echo e($announcement->isNew() ? 'Baru' : $announcement->publish_date->diffForHumans()); ?>
                            ...
                            <div class="flex items-center text-sm text-gray-500 mb-3">
                                <div class="flex items-center mr-4">
                                    ...
                                    <span><?php echo e($announcement->author->name); ?></span>
                                </div>
                                <div class="flex items-center">
                                    <i class="fas fa-calendar-alt mr-1.5 text-gray-400"></i>
                                    <span><?php echo e($announcement->publish_date->format('d M Y, H:i')); ?></span>
                                </div>
                            </div>
                            
                            <div class="mb-4">
                                <p class="text-gray-600 line-clamp-2 text-sm"><?php echo e($announcement->excerpt()); ?></p>
                            </div>
                            
                            <div class="flex items-center justify-between">
                                <a href="<?php echo e(route('siswa.announcements.show', $announcement->id)); ?>" class="text-red-600 hover:text-red-800 font-medium inline-flex items-center group">
                                ...
                                <?php if($announcement->hasAttachment()): ?>
                                    <div class="flex items-center text-gray-500 text-sm">
                                        ...
                                        <span><?php echo e($announcement->getAttachmentName()); ?></span>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SEMUA TENTANG KULIAH\SEMESTER 4\PA2\IMPLEMENTASI NEW\sman1-girsip\resources\views/siswa/announcements/index.blade.php ENDPATH**/ ?>