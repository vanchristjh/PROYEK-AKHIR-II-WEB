...
<?php $__env->startSection('header', 'Detail Kelas'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="bg-gradient-to-r from-purple-500 to-purple-600 rounded-xl shadow-lg p-6 mb-6 text-white relative overflow-hidden animate-fade-in">
        ...
        <div class="relative z-10">
            <div class="flex justify-between items-center">
                <div>
                    <h2 class="text-2xl font-bold mb-2"><?php echo e($classroom->name); ?></h2>
                    <p class="text-purple-100">Detail dan informasi kelas</p>
                </div>
                <div class="flex space-x-2">
                    <a href="<?php echo e(route('admin.classrooms.edit', $classroom)); ?>" class="px-4 py-2 bg-white text-purple-600 rounded-lg hover:bg-purple-100 transition-all duration-300 flex items-center shadow-md">
                        <i class="fas fa-edit mr-2"></i> Edit Kelas
                    </a>
                    <a href="<?php echo e(route('admin.classrooms.export', $classroom)); ?>" class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-all duration-300 flex items-center shadow-md">
                        <i class="fas fa-file-export mr-2"></i> Export PDF
                    </a>
                    <a href="<?php echo e(route('admin.classrooms.index')); ?>" class="px-4 py-2 bg-purple-700 text-white rounded-lg hover:bg-purple-800 transition-all duration-300 flex items-center shadow-md">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-6">
        <div class="bg-white border border-gray-100 rounded-xl shadow-sm p-5 hover:shadow-md transition-all duration-300 flex items-center relative overflow-hidden">
            ...
            <div>
                ...
                <div class="flex items-center">
                    ...
                    ?>
                    <span class="text-2xl font-bold text-gray-800"><?php echo e($studentCount); ?></span>
                    <span class="text-sm text-gray-400 ml-2">/ <?php echo e($classroom->capacity); ?></span>
                </div>
            </div>
        ...
        <div class="bg-white border border-gray-100 rounded-xl shadow-sm p-5 hover:shadow-md transition-all duration-300 flex items-center relative overflow-hidden">
            ...
            <div>
                ...
                <div class="flex items-center">
                    <span class="text-2xl font-bold text-gray-800"><?php echo e($classroom->subjects->count()); ?></span>
                </div>
            </div>
            <div class="absolute bottom-0 right-0 h-20 w-20 opacity-5">
        ...
        <div class="bg-white border border-gray-100 rounded-xl shadow-sm p-5 hover:shadow-md transition-all duration-300 flex items-center relative overflow-hidden">
            ...
            <div>
                ...
                <div class="flex items-center">
                    <span class="text-2xl font-bold text-gray-800"><?php echo e($studentCount >= $classroom->capacity ? 'Penuh' : 'Tersedia'); ?></span>
                </div>
            </div>
            <div class="absolute bottom-0 right-0 h-20 w-20 opacity-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <div class="mb-4">
                                ...
                                <p class="text-lg font-semibold text-gray-800"><?php echo e($classroom->name); ?></p>
                            </div>
                            
                            <div class="mb-4">
                                <h4 class="text-sm font-medium text-gray-500">Tingkat</h4>
                                <p class="text-lg font-semibold text-gray-800">Kelas <?php echo e($classroom->grade_level); ?></p>
                            </div>
                            
                            <div class="mb-4">
                                <h4 class="text-sm font-medium text-gray-500">Tahun Akademik</h4>
                                <p class="text-lg font-semibold text-gray-800"><?php echo e($classroom->academic_year); ?></p>
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="mb-4">
                                ...
                                <?php if($classroom->homeroomTeacher): ?>
                                    <div class="flex items-center mt-1">
                                        ...
                                        <div>
                                            <p class="text-md font-semibold text-gray-800"><?php echo e($classroom->homeroomTeacher->name); ?></p>
                                            <p class="text-xs text-gray-500"><?php echo e($classroom->homeroomTeacher->email); ?></p>
                                        </div>
                                    </div>
                                <?php else: ?>
                            ...
                            <div class="mb-4">
                                ...
                                <p class="text-lg font-semibold text-gray-800"><?php echo e($classroom->room_number ?? 'Belum ditetapkan'); ?></p>
                            </div>
                            
                            <div class="mb-4">
                                <h4 class="text-sm font-medium text-gray-500">Kapasitas</h4>
                                <p class="text-lg font-semibold text-gray-800"><?php echo e($classroom->capacity); ?> siswa</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-5 border-b border-gray-200 bg-gradient-to-r from-amber-50 to-amber-100">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="bg-amber-100 text-amber-800 text-xs font-medium px-2.5 py-0.5 rounded-full">
                            <?php echo e($classroom->subjects->count()); ?> mata pelajaran
                        </span>
                    </div>
                </div>
                
                <div class="p-5">
                    <?php if($classroom->subjects->isEmpty()): ?>
                        <div class="text-center py-6">
                            ...
                            <a href="<?php echo e(route('admin.classrooms.edit', $classroom)); ?>" class="inline-flex items-center px-4 py-2 bg-amber-600 text-white rounded-md hover:bg-amber-700 transition-colors">
                                <i class="fas fa-plus mr-2"></i> Tambahkan Mata Pelajaran
                            </a>
                        </div>
                    <?php else: ?>
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                            <?php $__currentLoopData = $classroom->subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="bg-white border border-amber-200 rounded-lg p-3 hover:shadow-md transition-all hover:bg-amber-50/30 hover:-translate-y-0.5 transform duration-300">
                                    <div class="flex justify-between items-center">
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                <h4 class="text-sm font-medium text-gray-800"><?php echo e($subject->name); ?></h4>
                                                <p class="text-xs text-gray-500">Kode: <?php echo e($subject->code); ?></p>
                                            </div>
                                        </div>
                                        <a href="<?php echo e(route('admin.subjects.show', $subject)); ?>" class="text-amber-600 hover:text-amber-900 bg-amber-100 hover:bg-amber-200 p-1 px-2 rounded-md transition-colors">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex space-x-2">
                            <span class="bg-blue-100 text-blue-800 text-xs font-medium px-2.5 py-0.5 rounded-full">
                                <?php echo e($studentCount); ?>/<?php echo e($classroom->capacity); ?> siswa
                            </span>
                            <a href="<?php echo e(route('admin.users.create')); ?>?role=siswa&classroom_id=<?php echo e($classroom->id); ?>" 
                ...
                <div class="p-5 max-h-[500px] overflow-y-auto">
                    ...
                    <?php if($students->isEmpty()): ?>
                        <div class="text-center py-6">
                            ...
                            <a href="<?php echo e(route('admin.users.create')); ?>?role=siswa&classroom_id=<?php echo e($classroom->id); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors">
                    ...
                    <?php else: ?>
                            ...
                            <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center justify-between p-2 border border-gray-200 rounded-lg hover:bg-blue-50 transition-all duration-300">
                                    ...
                                    <div class="flex space-x-1">
                                        <a href="<?php echo e(route('admin.users.show', $student)); ?>" class="text-blue-600 hover:text-blue-900 bg-blue-50/50 hover:bg-blue-100 p-1 px-2 rounded-md transition-colors">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="<?php echo e(route('admin.users.edit', $student)); ?>" class="text-blue-600 hover:text-blue-900 bg-blue-50/50 hover:bg-blue-100 p-1 px-2 rounded-md transition-colors">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <button type="button" onclick="confirmRemoveStudent('<?php echo e($student->name); ?>', '<?php echo e(route('admin.classrooms.removeStudent', ['classroom' => $classroom->id, 'student' => $student->id])); ?>')" 
                        ...
                        <div class="mt-4 text-center">
                            <a href="<?php echo e(route('admin.users.create')); ?>?role=siswa&classroom_id=<?php echo e($classroom->id); ?>" class="inline-flex items-center px-3 py-1 text-sm bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors">
    ...
    <div class="mt-6 flex flex-wrap space-x-2">
        <a href="<?php echo e(route('admin.classrooms.index')); ?>" class="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors mb-2">
            <i class="fas fa-arrow-left mr-2"></i> Kembali ke Daftar Kelas
        </a>
        <a href="<?php echo e(route('admin.classrooms.edit', $classroom)); ?>" class="px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors mb-2">
            <i class="fas fa-edit mr-2"></i> Edit Kelas
        </a>
        <button onclick="confirmDelete('<?php echo e($classroom->name); ?>', '<?php echo e(route('admin.classrooms.destroy', $classroom)); ?>')" class="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors mb-2">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SEMUA TENTANG KULIAH\SEMESTER 4\PA2\IMPLEMENTASI NEW\sman1-girsip\resources\views/admin/classrooms/show.blade.php ENDPATH**/ ?>