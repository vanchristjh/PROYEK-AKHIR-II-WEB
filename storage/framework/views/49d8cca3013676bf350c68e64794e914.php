...
<?php $__env->startSection('header', 'Tambah Mata Pelajaran'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="bg-white rounded-xl shadow-md p-6 mb-6">
            ...
            <div class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4 mb-4">
                <div class="flex items-center">
                    ...
                    <span>
                        ...
                        <a href="<?php echo e(url('/diagnostic/teachers')); ?>" target="_blank" class="text-blue-600 underline">
                            Lihat Diagnostik
                        </a>
                    </span>
                </div>
        ...
        <!-- Create form -->
        <form action="<?php echo e(route('admin.subjects.store')); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="code" id="code" value="<?php echo e(old('code')); ?>" class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-amber-500 focus:border-amber-500 sm:text-sm" placeholder="Contoh: MTK01" required>
                </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="name" id="name" value="<?php echo e(old('name')); ?>" class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-amber-500 focus:border-amber-500 sm:text-sm" placeholder="Nama mata pelajaran" required>
                </div>
            </div>
                ...
                <div class="relative mt-1">
                    ...
                    <select name="teachers[]" id="teachers" multiple class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-amber-500 focus:border-amber-500 sm:text-sm" size="5">
                        <?php $__empty_1 = true; $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <option value="<?php echo e($teacher->id); ?>" <?php echo e(in_array($teacher->id, old('teachers', [])) ? 'selected' : ''); ?>>
            ...
            <div class="flex items-center justify-end space-x-3 pt-5 border-t border-gray-200">
                <a href="<?php echo e(route('admin.subjects.index')); ?>" class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SEMUA TENTANG KULIAH\SEMESTER 4\PA2\IMPLEMENTASI NEW\sman1-girsip\resources\views/admin/subjects/create.blade.php ENDPATH**/ ?>