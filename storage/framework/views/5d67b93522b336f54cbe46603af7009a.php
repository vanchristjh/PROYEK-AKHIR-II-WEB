...
<?php $__env->startSection('title', 'Buat Tugas Baru'); ?>

<?php $__env->startSection('header', 'Buat Tugas Baru'); ?>
...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden border border-gray-200">
        ...
        <form action="<?php echo e(route('guru.assignments.store')); ?>" method="POST" enctype="multipart/form-data" class="p-6" id="assignment-form">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="datetime-local" name="deadline" id="deadline" value="<?php echo e(old('deadline')); ?>" 
                           class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                           required>
                    ...
                    <?php if(count($classes) > 0): ?>
                        <div class="mt-1 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                            ...
                            <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="relative flex items-start">
                                    <div class="flex items-center h-5">
                                        <input type="checkbox" name="classes[]" id="class-<?php echo e($class->id); ?>" value="<?php echo e($class->id); ?>" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="late_submission_penalty" id="late_submission_penalty" 
                                   value="<?php echo e(old('late_submission_penalty', 0)); ?>"
                                   min="0" max="100"
                                   class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SEMUA TENTANG KULIAH\SEMESTER 4\PA2\IMPLEMENTASI NEW\sman1-girsip\resources\views/guru/assignments/create.blade.php ENDPATH**/ ?>